...
3. Inside gdb:
   ...
   - `disas main` — disassemble `main`. Compare it against `../toolchain/labs/hello.s` — same logic, possibly a different syntax (gdb may default to AT&T or Intel depending on your setup; `set disassembly-flavor att` forces AT&T to match what you already know)
